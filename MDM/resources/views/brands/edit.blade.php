                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('brands.update', $brand->id) }}">
                        ...
                        <div class="form-group row mb-3">
                            <label for="code" class="col-md-4 col-form-label text-md-right">Brand Code</label>

                            <div class="col-md-6">
                                <input id="code" type="text" class="form-control @error('code') is-invalid @enderror" name="code" value="{{ old('code', $brand->code) }}" required>
